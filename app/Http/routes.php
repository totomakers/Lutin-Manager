...
Route::group(['as' => 'orders', 'prefix' => 'orders'], function () //plurial is always better for routes
{
    ...
    Route::get('/deliverynote',         ['as' => '::delivery','middleware' => 'auth.rank:0', 'uses' => 'OrderController@deliveryNote']);
});
...
Route::group(['as' => 'items', 'prefix' => 'items'], function()
{
    ...
    Route::put('/',                     ['as' => '::update',  'middleware' => 'auth.rank:1', 'uses' => 'ItemController@update']);
